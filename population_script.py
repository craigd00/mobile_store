...
def populate():
    ...
    add_item(title='Samsung Galaxy 10',
        price=799,
        discount_price=699,
        category='Android',
        label='primary',
    ...
    add_item(title='Samsung Galaxy S9',
        price=450,
        discount_price=399,
        category='Android',
        label='primary',
    ...
    add_item(title='Samsung Galaxy S8',
        price=250,
    ...
    add_item(title='Samsung Note 10',
        price=564.99,
        discount_price=0,
        category='Android',
        label='primary',
